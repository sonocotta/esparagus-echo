...
#define I2S_MIC_SERIAL_CLOCK PIN_I2S0_SCK
#define I2S_MIC_LEFT_RIGHT_CLOCK PIN_I2S0_FS
#define I2S_MIC_SERIAL_DATA PIN_I2S0_SDIN
...
#define I2S_SPEAKER_SERIAL_CLOCK PIN_I2S0_SCK
#define I2S_SPEAKER_LEFT_RIGHT_CLOCK PIN_I2S0_FS
#define I2S_SPEAKER_SERIAL_DATA PIN_I2S0_SDOUT

// Shutdown line if you have this wired up or -1 if you don't
#define I2S_SPEAKER_SD_PIN PIN_DAC_EN

// transmit button
#define GPIO_TRANSMIT_BUTTON PIN_BTN_TRANSMIT
